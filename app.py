...
# Load environment variables and configure Google AI
load_dotenv()
...
def main():
    ...
    with st.sidebar:
        ...
        st.image("learnMate.png", width="stretch")
        ...
        for icon, page in menu_items:
            ...
            if st.button(f"{icon} {page}", key=f"nav_{page}", type="primary" if is_active else "secondary", width="stretch"):
